...
**NOTE:** This library is a branch adding Lagrangian particle tracking (LPT), 'do_step' with additiona LPT functionality, in the 'advect_particles' class. This adds the ability to move particles based on particle size and density. The LPT has been tailoured to microfluidic channels with assumption of the wall lift. See ![NanoMedic.org](https://nanomedic.org) for more information.
